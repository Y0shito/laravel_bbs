    ...
    <div class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav
                ...
                <a class="mr-1 text-white bg-gray-600 border-0 py-1 px-3 rounded">ブックマークした記事</a>
                    ...
                    <div class="py-8 flex flex-wrap md:flex-nowrap">
                        <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                            ...
                            <span class="mt-1 text-gray-400 inline-flex items-center leading-none text-sm pb-1">
                                ...
                                {{ $article->article->created_at->format('Y年m月d日') }}
                            </span>
                            @isset($article->article->updated_at)
                                <span class="text-gray-400 inline-flex items-center leading-none text-sm pb-1">
                                    ...
                                    {{ $article->article->updated_at->format('Y年m月d日') }}
                                </span>
                            @endisset
